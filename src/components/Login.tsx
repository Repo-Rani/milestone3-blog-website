...
const Login = ({ isOpen, onClose }: any) => {
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center px-14 mx-auto md:h-[80vh] lg:py-0">
          <div className="w-[40rem] bg-black rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-[#F2613F]  hover:bg-white hover:text-[#F2613F] font-medium rounded-lg text-[18px] px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Log in
                </button>
