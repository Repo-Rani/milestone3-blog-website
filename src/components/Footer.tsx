        ...
        <div className="mt-[50px] py-5 flex flex-col lg:flex-row items-center justify-between text-white  gap-12 lg:gap-0">
          ...
          <div className="flex-1 flex flex-col gap-5">
            ...
            <p className="font-light text-base italic md:ml-[4rem] ml-[2rem] ">
              Discover the wonders of the world, one unforgettable journey at a
              time. From breathtaking landscapes to hidden gems, lets embark on
              adventures that inspire, connect, and create lifelong memories.
              Your next great story begins here lets explore the endless beauty
              of travel together!{" "}
            </p>
          ...
          <div className="flex-1 flex flex-row lg:flex-row justify-center gap-14 lg:gap-20 w-[70%] mx-auto ">
            ...
            <div className="flex flex-col gap-3 font-light">
              ...
              <Link
                href="/"
                className="nav_link hover:text-[#F2613F] transition-all duration-200 hover:scale-105"
              >
                Destination
              </Link>
              <Link
